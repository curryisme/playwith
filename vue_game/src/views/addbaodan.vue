          ...
          <el-tabs type="border-card">
            <el-tab-pane>
              ...
              <el-table :data="tableData1" border stripe style="width: 100%">
                <el-table-column prop="pworderxm" label="陪玩项目">
                </el-table-column>
                <el-table-column prop="pworderlaobanUsername" label="陪玩老板">
                </el-table-column>
                <el-table-column prop="pworderprice" label="陪玩单价/h">
                </el-table-column>
                <el-table-column prop="pworderduration" label="陪玩时长">
                </el-table-column>
                <el-table-column prop="pwordertime" label="陪玩时间">
                </el-table-column>
                <el-table-column prop="pwordertime" label="陪玩时间">
                </el-table-column>
                <el-table-column prop="pwordercreatetime" label="报单时间">
                </el-table-column>
              </el-table>
            </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    async getpwlist() {
      ...
      try {
        let res = await getBaodanBypwid({ pwuserid: this.userData.Id });
        if (res.success) {
