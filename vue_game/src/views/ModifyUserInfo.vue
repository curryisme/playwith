<template>
  <div class="detail">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        >
          <div class="user-base-info clearfix">
            ...
            <img :src="userImg" class="head fl" v-if="userImg" />
            <img
          ...
          <div class="row flex align-items">
            ...
            <el-radio-group v-model="userSex" fill="#000000">
          ...
          <div class="row flex align-items">
            <Icon type="md-star" class="star" color="#FF8383" />
            <div class="name date flex align-items space-between">
              出生日期：
            </div>
          ...
          <div class="row flex align-items">
            ...
            <div class="upload-wrap fl">
              <audio controls ref="singeBox" :src="userAudio"></audio>
              <div class="btn-wrap" style="float: right; margin: 10px">
                <input
                  type="file"
                  class="filepath"
          ...
          <div class="btn unselect btnclick" @click="toAuth">
            确认提交
          </div></el-tab-pane
        >
        <!-- <el-tab-pane label="陪玩中心" name="pwCenter"></el-tab-pane> -->
        <el-tab-pane
          label="主玩游戏"
    ...
    <quickBtn />
    <foot />
    <el-dialog title="邮箱绑定" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        ...
        <el-form-item label=" 验 证 码 ：" label-width="100px">
          <el-input
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="emailContrim">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async gotUserInfo() {
      console.log(this.userData, "asda");
